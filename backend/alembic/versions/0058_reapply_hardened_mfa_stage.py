"""Reapply the corrected recovery-enrollment state transition.
...
def upgrade() -> None:
    ...
    statement = source_0057.STAGE_MFA_ENROLLMENT_SQL.replace(
        "CREATE FUNCTION public.stage_auth_mfa_enrollment",
        "CREATE OR REPLACE FUNCTION public.stage_auth_mfa_enrollment",
        1,
    )
    op.execute(statement)
    signature = "public.stage_auth_mfa_enrollment(" "TEXT, TEXT, SMALLINT, TEXT, TEXT[])"
