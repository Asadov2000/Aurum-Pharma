...
CUSTOM_FUNCTIONS = {
    ...
    "lookup_auth_account_mfa_requirement",
    ...
    "worker_claim_notification_deliveries",
    "worker_complete_notification_delivery",
    "worker_enqueue_expiring_license_notifications",
    "worker_list_automatic_trial_candidates",
    "worker_purge_expired_email_codes",
    "worker_purge_expired_sessions",
    "worker_purge_old_notifications",
    "worker_start_automatic_trial",
    ...
    "trg_validate_supplier_movement_provenance",
