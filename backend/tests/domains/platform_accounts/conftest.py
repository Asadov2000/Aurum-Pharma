"""HTTP fixture for platform account lifecycle tests."""
...
from app.core.deps import _seed_request_db_context, get_auth_db, get_db
from app.main import app


@pytest_asyncio.fixture
async def platform_accounts_client(
