...
const routeBudgets = [
  ...
  },
  {
    ...
    // Public activation and the capability-gated billing workspace add small
    // shared router metadata while both page implementations remain lazy.
    maxRawBytes: 612 * 1024,
